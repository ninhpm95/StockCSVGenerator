JPY_HEDGED = [
    # JPY hedged ETFs that are not suitable for long-term buy-and-hold investing
    ...
    "183A", # MAXIS US Treasury Bond 20+ Year ETF (JPY Hedged)
    ...
    "2091", # NZAM ETF German Government Bond 7-10Y (JPY Hedged)
    ...
    "238A", # iShares 25+ Year US Treasury Bond Long Duration JPY Hedged ETF
    "2512", # NEXT FUNDS International Bond FTSE World Government Bd Idx ex Jpn Hdg ETF
    "2514", # NEXT FUNDS International Equity MSCI-KOKUSAI (Yen-Hedged) ETF
    "2521", # Listed Index Fund US Equity (S&P500) Currency Hedge
    "2554", # NEXT FUNDS Bloomberg US Intermediate Corporate Index (JPY Hedged) Exchange Traded Fund
    ...
    "2648", # NEXT FUNDS Bloomberg US Treasury Bond (7-10 year) Index (Yen-Hedged) ETF
    ...
    "2853", # iShares Climate Risk-Adjusted Global ex Japan Government Bond JPY Hdg ETF
    ...
    "376A", # NEXT FUNDS Bloomberg US Treasury Bond (7-10 year) Index (75% Yen-Hedged)ETF
    "382A", # iFreeETF US Treasury Bond 3-5 Year (JPY HEDGED)
    "424A", # Global X Gold ETF (JPY Hedged)
    "448A", # State Street SPDR Gold ETF (JPY Hedged)
    "450A", # State Street SPDR S&P 500 ETF (JPY Hedged)
    "467A", # Global X USD Investment Grade Corporate Bond ETF (JPY Hedged)
    "491A", # iShares S&P 500 Ex-Financials JPY Hedged ETF
    "578A", # Global X Silver ETF (JPY Hedged)
]
